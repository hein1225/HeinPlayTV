        ...
        child: Column(
          children: [
            ...
            HotMoviesSection(
              ...
              onMoreTap: () => _onCategoryChanged(1),
            ...
            HotTvSection(
              ...
              onMoreTap: () => _onCategoryChanged(2),
              onGlobalMenuAction: (videoInfo, action) {
                if (action == VideoMenuAction.play) {
                  _navigateToPlayer(
                    PlayerScreen(
            ...
            BangumiSection(
              ...
              onMoreTap: () => _onCategoryChanged(3),
              onGlobalMenuAction: (videoInfo, action) {
                if (action == VideoMenuAction.play) {
                  _navigateToPlayer(
                    PlayerScreen(
            ...
            HotShowSection(
              ...
              onMoreTap: () => _onCategoryChanged(4),
              onGlobalMenuAction: (videoInfo, action) {
                if (action == VideoMenuAction.play) {
                  _navigateToPlayer(
                    PlayerScreen(
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        if (_currentCategoryIndex != 0) {
          // 回到首页
          _onCategoryChanged(0);
          return false; // 阻止默认返回行为
        }
        return true; // 允许默认返回行为
      },
      child: MainLayout(
        content: _buildCategoryPageView(),
